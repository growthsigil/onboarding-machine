...
2. Open **SQL Editor → New query**, paste the entire contents of
   [`db/schema.sql`](db/schema.sql), and press **Run**. (You'll come back to
...
2. **Important:** if this app lives in a subfolder of your repo, set **Root
...
2. In Supabase → SQL Editor, re-run `db/schema.sql` **after** replacing
